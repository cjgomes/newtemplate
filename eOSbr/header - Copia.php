...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
            ...
            <div class="container">
            <div class="logo unit one-of-five alignleft"><a href="<?php bloginfo('url'); ?>"><img src="<?php echo get_template_directory_uri(). '/images/logo.png';  ?>"/></a></div>     
			<?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_class' => 'unit three-of-five alignleft' ) ); ?>
            <?php get_search_form(); ?>
            <?php 
